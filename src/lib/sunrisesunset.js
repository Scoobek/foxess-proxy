...
export async function fetchSunriseSunset() {
    ...
    try {
        ...
        if (data.status === "OK" && data.results) {
            ...
            // Aktualizuj stan bojlera
            bojlerState.sunrise = sunrise;
            bojlerState.sunset = sunset;

            console.log(`[sunrisesunset] sunrise: ${sunrise}, sunset: ${sunset}`);
        ...
        console.error("[sunrisesunset] Błąd:", err.message);
